...
from ordersapp.models import Order, ClientOrder
...
def payment_process(request):
    ...
    # данные сеанса оформления платежа Stripe
        ...
        user_create_order = ClientOrder(order_id_client=request.user.id, order_id_order=order.id, )
        user_create_order.save()
